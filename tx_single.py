...
# Generated: Tue Aug  8 17:25:20 2017
##################################################
...
class tx_single(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "TX Single")
        ...
        try: split1ip = self._split1ip_config.get("ping", "repforwardip")
        except: split1ip = "127.0.0.1"
        self.split1ip = split1ip
        self._pingport_config = ConfigParser.ConfigParser()
        self._pingport_config.read('default')
        try: pingport = self._pingport_config.get("ping", "repforwardport")
        except: pingport = "2667"
        ...
        # Blocks
        ##################################################
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_gr_complex, 1, '"tcp://" + repforwardip + ":" + repforwardport', 100, False, -1)
    ...
    def get_pingport(self):
        return self.pingport

    def set_pingport(self, pingport):
        self.pingport = pingport
...
def main(top_block_cls=tx_single, options=None):
