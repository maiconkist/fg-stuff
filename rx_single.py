...
# Title: OFDM Single
# Description: Single
# Generated: Wed Aug  9 13:19:04 2017
##################################################
...
class rx_single(gr.top_block):
    ...
    def __init__(self):
        ...
        self._myport_config = ConfigParser.ConfigParser()
        self._myport_config.read('default')
        try: myport = self._myport_config.get("rx", "port")
        except: myport = "2666"
        self.myport = myport
        self._myip_config = ConfigParser.ConfigParser()
        self._myip_config.read('default')
        try: myip = self._myip_config.get("rx", "ip")
        except: myip = "127.0.0.1"
        self.myip = myip
        ...
        # Blocks
        ##################################################
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_gr_complex, 1, "tcp://" + myip + ":" + myport, 100, True, -1)
