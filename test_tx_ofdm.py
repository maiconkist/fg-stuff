...
# Generated: Thu Sep 21 17:22:01 2017
##################################################
...
class test_tx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_tx_ofdm")
        self.restoreGeometry(self.settings.value("geometry").toByteArray())

        ##################################################
        # Variables
        ##################################################
        self.pilot_carriers = pilot_carriers = ((-60,-49,-35, -21, -7, 7, 21, 35, 49, 60),)
...
def main(top_block_cls=test_tx_ofdm, options=None):
