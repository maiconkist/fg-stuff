...
class supertestrx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Supertestrx")
        ...
        # Blocks
        ##################################################
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_char, 1, "tcp://" + repforwardip + ":" + payloadport, 100, True, -1)
        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_char, 1, "tcp://" + ip + ":" + payloadport, 100, True, -1)
...
def main(top_block_cls=supertestrx, options=None):
